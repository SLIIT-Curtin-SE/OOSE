...
import edu.curtin.reminder.model.FileManager;
import edu.curtin.reminder.model.Observers;
 ...
 */
public class MainWindow implements Observers
{
    ...
    public void update() {
        try{
            new FileManager().write(REMINDER_FILE, controller.getReminders());
        } catch (IOException e){
